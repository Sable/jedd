 ...
 * Copyright (C) 2003, 2006 Ondrej Lhotak
 *
...
public class ZBuddyBackend extends Backend {
    ...
    synchronized RelationInstance trueBDD() {
        throw new RuntimeException("No trueBDD in ZBDDs");
    }
    synchronized protected RelationInstance ithVar( int i ) {
        throw new RuntimeException("No nithvar in ZBDDs");
    }
